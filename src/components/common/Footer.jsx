			...
			<div className='footer'>
				<div className="depth1">
					<ul className='big'>
						...
						<li className='list'>
							<h4 className='mt'><Link to='/medicine'>한화제약</Link></h4>
							<ul>
								<li><Link to='/medicine/history'>연혁</Link></li>
								<li><Link to='/medicine/family'>가족친화경영</Link></li>
								<li><Link to='/medicine/products'>제품소개</Link></li>
								<li><Link to='/medicine/location'>찾아오시는 길</Link></li>
								<li><Link to='/medicine/ingredients'>의약품효능군</Link></li>
							</ul>
						</li>
						<li className='list'>
